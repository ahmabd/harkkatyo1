...
-		
-		//SALI-luokan lis��N�yt�s - metodi
-		print("lis�t��n n�yt�s teatteri1:n sali 3:n ja 2:n tietoihin");
-		lisays = teatteri1.annaSali(3).lisaaNaytos(naytos);
-		onnistuiko(lisays);
-		lisays = teatteri1.annaSali(2).lisaaNaytos(naytos);
-		onnistuiko(lisays);
-		print("Koitetaan lis�t� sama n�yt�s uudelleen saliin 3");
-		lisays = teatteri1.annaSali(3).lisaaNaytos(naytos);
-		onnistuiko(lisays);
-		
-		
-		//setterit
-		//print("muutetaan n�yt�ksen tietoja. Koska voidaan.");		
-		
-	}
-	
-	/**
...
-		}else{
-			print("lis�ys ei onnistunut, salissa jo n�yt�s samaan aikaan!");
-		}
-	}
-
-}